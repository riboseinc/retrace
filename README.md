...
if this option (without paramters) is present, no buffers will be dumped. This can be useful to get
a cleaner output. It will even speed up the tracing if you a lot of buffers are being printed.
