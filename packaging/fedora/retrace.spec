...
# Install: dnf install retrace-2.8.0-1.*.rpm
...
%changelog
* Wed Aug 19 2026 Ribose Inc <opensource@ribose.com> - 2.8.0-1
- retrace-procmon2retrace: procmon CSV to retrace JSON producer
