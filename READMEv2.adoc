...
The retrace logger can be controlled using the following enviroment variables:


`RETRACE_LOGGER_DEF_ENA` Setting this to 0 will completly disable the `retrace` logging engine.
