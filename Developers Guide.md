...
compile and install "cmocka" library,
then execute `./configure --with-cmocka=[installation root]` (we skip building cmocka tests if this library and headers are not found in the default system folders)
