...
# ADDRESS AND HOSTNAME. IT IS NOT MEANT AS A STANDALONE FUZZING TOOL. YOU CAN
# USE IT FOR INSPIRATION AND TO GIVE YOU AN IDEA HOW RETRACE CAN BE USED TO FUZZ
# NAMESERVERS.
#
# Dependencies:
